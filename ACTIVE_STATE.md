...
The all-offset law now transfers the FULL child maximum on a declared
subexponential old code, at subleading ensemble-comparison error. Equal
variance forces some offset loss, while unimodal independent offset
averaging restores variance concavity. Actual-child shape, favorable
parent VALUE and old-state escape remain open, separate obligations.
