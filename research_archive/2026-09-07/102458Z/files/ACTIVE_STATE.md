...
Evidence cutoff: fourth material checkpoint of the active flatification
...
Latest actual operation: center-conditioned rank-two bridges control a
joint noisy-response sector around arbitrary actual child centers, without
spectral flatness. The all-common-noise-level certificate at c>=.47 has an
all-order sector realization. Exceptional pairs and arbitrary energy
windows remain unpaid; no full-parent bound follows. See checkpoint four.
