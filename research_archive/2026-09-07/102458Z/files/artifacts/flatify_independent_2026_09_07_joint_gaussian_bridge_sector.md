...
Later simplification: the elementary localized/dephased-Hadamard operation
in `flatify_adversary_2026_09_07_dephased_hadamard_energy_window_audit.md`
controls ALL spins in the same fixed-center child-energy windows, without
profile assumptions. The kernel theorem below remains correct, but its
profile restriction is unnecessary for that window application.
