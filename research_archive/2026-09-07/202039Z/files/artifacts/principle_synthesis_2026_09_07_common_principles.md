...
| Constant two-spin independent frames | Every fixed bounded-cap seed, then independent exact two-row frames; typical actual cap above .50717 | Correlated frames; rare selected completions; one simultaneous event for adaptive seeds |
