...
% Captions are trimmed to the body-text width: the body runs inside the
% abstract's quotation block (see paper/ai_paper_abstract.tex), which indents
% it by \leftmargini = 30pt on each side, while floats keep full column width.
\usepackage{caption}
...
%   Abstract
%   Introduction -- core contributions, theorem statements
%   Background on the Grothendieck constant + high-level companion results
%   AI methodology
%   Case study
%   Discussion
%   Future Work
...
\input{paper/ai_paper_abstract}

\input{paper/ai_paper_introduction}

\input{paper/ai_paper_grothendieck}
