...
SOURCE=ROOT/'computations/twisted_chiral_classify10_2026_09_18.cpp'
BINARY=ROOT/'tmp/twisted_chiral_2026_09_18/classify10'
...
def main():
    ...
    def run(shard):
        ...
        with (ROOT/f'computations/results/twisted_chiral_2026_09_18_classify10_shard{shard}.jsonl').open('w') as handle:
    ...
    output=dict(schema='twisted-chiral-independent-order10-census-v1',complete=complete,
        ...
        shard_summaries=[rows[-1] for rows in shards],source=str(SOURCE.relative_to(ROOT)))
    (ROOT/'computations/results/twisted_chiral_2026_09_18_classify10.json').write_text(json.dumps(output,indent=2)+'\n')
