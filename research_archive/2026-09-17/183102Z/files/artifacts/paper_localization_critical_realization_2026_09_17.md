...
self-audited before circulation. Peer audit and finite replay results
are to be recorded here after completion. The constants are intentionally
not optimized; the essential feature is one relative-response certificate
for all matrices and all levels, together with covariance 1+o(1).
