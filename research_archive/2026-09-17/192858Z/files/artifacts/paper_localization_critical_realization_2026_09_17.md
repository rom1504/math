...
was independently rerun by the Bernoulli-track researcher, who also read
the entire proof and scalar-entropy prerequisite and returned PASS on all
finite constants and extension quantifiers. The replay
