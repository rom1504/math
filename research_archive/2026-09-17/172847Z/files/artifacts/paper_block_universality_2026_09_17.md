...
2026-09-17. **Proof reconstructed below; independent audit of the
independent-block statement passed. Backward-conditional extension pending
separate audit.** This extends the fixed-size block argument in
...
**Constructed and proved below; independent verification pending.**
