...
It comprises of goals that are not clearly defined and are constantly evolving. 
Succeses is judged not only by whether a statement gets proved, but by whether the right statement was chosen in the first place. 
It requires building a body of knowledge whose significance might not be apparent until much later; that is, in research, rewards are sparse, and often delayed.
...
% TODO: replace the placeholder key LiSahaXueChaudhuriKlivansKothariMeka2026companion
% with the bib entry for the companion (theory) paper once it is posted.
