...
Evidence cutoff: ledger Section 10.150.6, renewed campaign checkpoint 6.
...
3. First-marked signed feedback is banked. Test bounded-smooth mixed comparison
   for richer finite coherent frames without assuming moment determinacy, and
   uniformity of the existing fixed-L gain on compact source families. Neither
   extension nor domination of the spectral-deletion cost is presently proved.
