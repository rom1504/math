...
Evidence cutoff: ledger Section 10.151.1, first decisive-limit checkpoint.
...
\le\limsup M_n/n^{3/2}<0.496876095<1/2.
```

The new upper is `1/2-a_E/(8sqrt(p))`, with p=31/32 and
a_E=19678127864847/800000000000000; approximately .4968760940775481.
