...
at the same scale as the motivating problem.  The remaining question is
whether special quadratic near-minimizers occupy a rigid response subclass,
not whether arbitrary dense bridge responses are compressible.
