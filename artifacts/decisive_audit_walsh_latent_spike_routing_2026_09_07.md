...
This audit applies to the specified Walsh/full-column-permutation ensemble
and its INTER-GROUP positive partition. It does not import an extension
to arbitrary recursively randomized bases, restore omitted within-group
factors without an additional argument, or assert any lower bound on the
original minimizing cap. Those scope exclusions are mathematically real.
