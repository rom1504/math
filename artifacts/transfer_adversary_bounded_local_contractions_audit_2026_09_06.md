...
## 6. Independent finite algebra replay

At 22:06 UTC, independently ran the complete preserved checker
`computations/transfer_seed_local_sobolev_product_checks_2026_09_06.py`
with `.venv/bin/python`. It passed 90 finite-cube Sobolev checks,
90 weighted product checks and 8,726 factorial coefficient cases.
The numerical replay is a floating-point diagnostic, not an interval
or symbolic certificate; the identities rely on the written algebraic
proof. It does not verify the open two-root assembly.
