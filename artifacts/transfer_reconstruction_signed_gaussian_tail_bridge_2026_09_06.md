...
separate dependency, now proved in
`transfer_director_typical_hadamard_spectra_2026_09_06.md` and independently
reconstructed in `transfer_reconstruction_typical_hadamard_pressure_audit_2026_09_06.md`.
The conclusion is
