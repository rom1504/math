...
finite support LPs for archived exact children of orders3 through10, then
rationally reconstructs BOTH primal and dual solutions and checks all their
inequalities and equality of objectives exactly. In the two polarities the
certified values are respectively (3,3/2), (4,4), (5,5), (6,6),
(17/2,68/7), (32/3,32/3), (14,44/3), and (50/3,50/3). The generated JSON
retains the original solver values as diagnostics as well as exact objective
strings. The analytic pentagon equality above has no floating-point dependency.
