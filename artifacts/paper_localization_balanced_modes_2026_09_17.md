...
That direct criterion's finite whole-nearlevel entropy-slope premise was
subsequently proved impossible by a fixed-radius flip count. Sections 1--3
here use a CENTER cover and remain valid and potentially applicable;
their residual entropy is multiplied by the squared deviation radius.
The subsequent [critical arbitrary-frame realization](paper_localization_critical_realization_2026_09_17.md)
retains this anchored payment without requiring an orthogonal mode law.
