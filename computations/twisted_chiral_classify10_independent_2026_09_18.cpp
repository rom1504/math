...
// Independently exhaust disjoint shards of all 2^36 root-gauged order-ten signings. Independent
// signed half-edge energy tables evaluate q_A(x) directly, with no solver and no parent machinery.
...
int main(int argc,char**argv) {
  ...
  constexpr int half=18,side_count=1<<half;
