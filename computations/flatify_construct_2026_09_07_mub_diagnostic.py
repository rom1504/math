...
def main():
    ...
    Path("computations/results/flatify_construct_2026_09_07_mub_diagnostic.json").write_text(json.dumps(outputs, indent=2) + "\n")
    print(json.dumps([{k: v for k, v in row.items() if k != "witness"} for row in outputs], indent=2))
